...
import blue.base.core.reflect.ExecutableOperation;
import blue.base.core.reflect.MethodParam;
...
public abstract class DefaultExecutableOperation extends DefaultAnnotationOperation implements ExecutableOperation {
	...
	protected List<MethodParam> methodParamList;
	...
	@Override
	public final List<Class<?>> getParamClassList() {
		return paramClassList;
	}

	@Override
	public final List<MethodParam> getParamList() {
