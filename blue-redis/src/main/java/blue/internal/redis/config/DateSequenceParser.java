...
import blue.internal.redis.sequence.DateSequence;
 ...
 */
public class DateSequenceParser extends SimpleBeanDefinitionParser
{
	public DateSequenceParser()
	{
		this.clazz = DateSequence.class;
	}
