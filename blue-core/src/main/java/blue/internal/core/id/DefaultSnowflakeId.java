...
{
	public static final long EPOCH = 1577808000000L; // 开始时间戳 (2020-01-01)
	protected static Logger logger = LoggerFactory.getLogger(DefaultSnowflakeId.class);
	 ...
	 */
	public DefaultSnowflakeId(long machineId)
	{
	 ...
	 * @param machineId 机器ID
	 */
	public DefaultSnowflakeId(long machineIdBits, long sequenceBits, long machineId)
	{
	...
	public Metadata getMetadata(long id)
	{
		...
		return new DefaultSnowflakeIdMetadata(timestamp, sequence, machineId);
	}
