...
public class DefaultConvertService implements ConvertService
{
	...
	public DefaultConvertService()
	{
		...
		conversionService.addConverter(new DictionaryToStringConverter());
		...
		conversionService.addConverterFactory(new StringToDictionaryConverterFactory());
		conversionService.addConverterFactory(new NumberToDictionaryConverterFactory());
		conversionService.addConverterFactory(new DictionaryToNumberConverterFactory());
